    ...
    resources: {
      en: {
        translation: {
          ...
          nav: {
            ...
            settings: 'Settings',
            info: 'Info',
            skill_agent: 'Agent Skill',
          },
          skill: {
            title: 'Agent Skill Integration',
            description: 'Select a project to automatically install Antigravity Kit.',
            select_project: 'Select Project',
            install: 'Install Antigravity Kit',
            selected_path: 'Selected Project:',
            status: {
              idle: 'Ready to install.',
              installing: 'Installing... This may take a moment (cloning repository).',
      ...
      'zh-CN': {
        translation: {
          ...
          skill: {
            title: 'Agent Skill 集成',
            description: '选择项目以自动安装 Antigravity Kit。',
            select_project: '选择项目',
            install: '安装 Antigravity Kit',
            selected_path: '已选项目:',
            status: {
              idle: '准备安装。',
              installing: '正在安装... 可能需要一点时间 (克隆仓库)。',
              success: '安装成功！',
              error: '安装失败：{{message}}',
            },
          },
          info: {
            ...
            zalo: 'Zalo 群组',
            description: '获取最新消息和更新。',
            developed_by: '由 {{name}} 开发',
      ...
      ru: {
        translation: {
          ...
          skill: {
            title: 'Интеграция Agent Skill',
            description: 'Выберите проект для автоматической установки Antigravity Kit.',
            select_project: 'Выбрать проект',
            install: 'Установить Antigravity Kit',
            selected_path: 'Выбранный проект:',
            status: {
              idle: 'Готов к установке.',
              installing: 'Установка... Это может занять некоторое время (клонирование репозитория).',
          ...
          info: {
            ...
            contact: 'Контакты и сообщество',
            telegram: 'Telegram группа',
            zalo: 'Zalo группа',
            description: 'Будьте в курсе последних новостей и обновлений.',
            developed_by: 'Разработано {{name}}',
